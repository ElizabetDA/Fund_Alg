...
TEST(BigIntTest, MultiplicationKaratsuba) {
	// проверка на произвольных 2-х-значных -> работает через рекурсию Карацубы
	EXPECT_EQ(BigInt("12") * BigInt("34"), BigInt("408"));
	EXPECT_EQ(BigInt("1234") * BigInt("5678"), BigInt("7006652"));
}
